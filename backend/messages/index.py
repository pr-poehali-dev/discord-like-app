...
def handler(event: dict, context) -> dict:
    ...
    if method == "GET":
        ...
        cur = conn.cursor()
        cur.execute(
            f"SELECT id, user_id, username, avatar_color, text, created_at, file_url, file_name, file_type, edited, is_removed "
    ...
    if method == "POST":
        ...
        cur = conn.cursor()
        cur.execute(
            f"INSERT INTO {SCHEMA}.messages (server_id, channel_id, user_id, username, avatar_color, text, file_url, file_name, file_type) "
